function calcularInvestimentos(event) {
    ...
    document.getElementById('results').innerHTML = `
        ...
        <p>Retabilidade (R$${depositoMensal} por ${tempoMeses} meses): R$ ${(calcularMontante(taxasAnuais.poupanca, tempoMeses, contribPoupanca)-valorMeta)}</p>
        ...
        <p>Retabilidade (R$${depositoMensal} por ${tempoMeses} meses): R$ ${(calcularMontante(taxasAnuais.selic, tempoMeses, contribSelic)-valorMeta)}</p>
        ...
        <p>Retabilidade (R$${depositoMensal} por ${tempoMeses} meses): R$ ${(calcularMontante(taxasAnuais.cdb, tempoMeses,contribCDB)-valorMeta)}</p>
        ...
        <p>Retabilidade (R$${depositoMensal} por ${tempoMeses} meses): R$ ${(calcularMontante(taxasAnuais.fundosDI, tempoMeses, contribFundosDI)-valorMeta)}</p>`;
}
