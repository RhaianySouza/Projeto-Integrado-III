function calcularInvestimentos(event) {
    ...
    document.getElementById('results').innerHTML = `
        ...
        <p>Retabilidade (R$${depositoMensal} por ${tempoMeses} meses): R$ ${(valorMeta-calcularMontante(taxasAnuais.poupanca, tempoMeses, contribPoupanca))}</p>
        ...
        <p>Retabilidade (R$${depositoMensal} por ${tempoMeses} meses): R$ ${(valorMeta-calcularMontante(taxasAnuais.selic, tempoMeses, contribSelic))}</p>
        ...
        <p>Retabilidade (R$${depositoMensal} por ${tempoMeses} meses): R$ ${(valorMeta-calcularMontante(taxasAnuais.cdb, tempoMeses,contribCDB))}</p>
        ...
        <p>Retabilidade (R$${depositoMensal} por ${tempoMeses} meses): R$ ${(valorMeta-calcularMontante(taxasAnuais.fundosDI, tempoMeses, contribFundosDI))}</p>`;
}
